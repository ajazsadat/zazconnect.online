    ...
    <div className="bg-[var(--background)] min-h-screen">
      ...
      {showTopCtas && (
        <section className="bg-white border-b border-[var(--line)]">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row gap-3 sm:justify-center">
            <a
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 px-6 py-3.5 font-semibold text-teal border border-teal/40 hover:bg-teal/5 transition"
            >
              Contact our team
            </Link>
          </div>
