...
export const metadata = {
  ...
  description: `Learn how ${SITE.legalName} operates ${SITE.brandFull} as an independent comparison and referral service.`,
};
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 grid lg:grid-cols-[1fr_1.1fr] gap-14">
        <div>
          ...
          <p className="text-muted leading-relaxed">
            {SITE.referralDisclosure} Our role is limited to informational support, helping customers compare available
            internet and bundled options, and assisting with enrollment by connecting you with the provider you choose.
          </p>
